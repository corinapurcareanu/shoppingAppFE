...
export class Hair implements OnInit{
  ...
  ngOnInit(): void {
   ...
   public getAllProducts() {
    ...
    this.productService.getAllProductsByType(this.pageNumber, "Hair Brush, Hair Pins, Hair Tie, Hair Balm, Hair Mask, Hair Oil, Shampoo, Hair Gel, Hair Spray, Hair Wax")
    .pipe(
