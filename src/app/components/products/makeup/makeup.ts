...
export class MakeUp implements OnInit{
  ...
  ngOnInit(): void {
   ...
   public getAllProducts() {
    ...
    this.productService.getAllProductsByType(this.pageNumber, "Make-up Brushes, Eyebrows Gel, Eyebrows Pencil, Eye Pencil, Eyeliner, False Lashes, Mascara, Make-up Palette, Concelear, Face Powder, Foundation, Gloss, Lip Balm, Lip Pencil, Lipstick, Nail Base, Nail Polish, Top Coat")
    .pipe(
